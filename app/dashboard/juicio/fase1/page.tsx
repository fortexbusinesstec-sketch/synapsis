...
import Fase1Client from '@/components/juicio/fase1/Fase1Client';

export default async function Fase1Page({ searchParams }: { searchParams: Promise<{ expertoId?: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <div className="container mx-auto p-4 max-w-4xl pt-8">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-4 sm:mb-6">Fase 1: Evaluación por Categorías</h1>

        <Fase1Client expertoCodigo={expertoCodigo} />
      </div>
    </div>
  );
}
