              ...
              <div className="flex items-center gap-3 px-4 sm:px-8 py-3 border-b border-slate-100 bg-white/50">
                {selectedModel ? (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-50 border border-emerald-200 hover:bg-emerald-100 transition-colors flex-shrink-0"
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-100 border border-slate-200 flex-shrink-0">
                    ...
                    >
                      {!selectedModel ? (
                        <>
                          ...
                          <div className="mt-4 p-6 bg-gradient-to-br from-slate-50 to-white rounded-3xl border border-slate-200 shadow-sm max-w-md w-full">
                            <p className="text-sm font-bold text-slate-600 mb-5 text-center">
                              Para escribir tu consulta debes seleccionar un modelo
                            </p>
                            <div className="flex justify-center gap-4">
                              {["3300", "5500"].map(model => (
                                <button
                                  ...
                                  className="group flex flex-col items-center gap-2 px-8 py-5 rounded-2xl border-2 border-slate-200 bg-white hover:border-blue-400 hover:shadow-lg hover:shadow-blue-500/10 hover:-translate-y-0.5 transition-all duration-200 active:scale-95"
                                >
                                  <span className="text-2xl font-black text-slate-800 group-hover:text-blue-600 transition-colors">
                                    {model}
                                  </span>
                                  <span className="text-[10px] font-bold text-slate-400 group-hover:text-blue-500 uppercase tracking-widest transition-colors">
                                    Seleccionar
                                  </span>
                                </button>
                              ))}
